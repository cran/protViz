    ...
    namespace ms{
      ...
      public:
        ...
        assignIsotopIntensities(TmassI beginMass, TmassI endMass, TinteI beginIntensity){
            ...
            double dIntensityL2,  dIntensityInnerProduct;
            ...
            for (std::vector< std::vector< std::vector< int > > >::iterator it_z = result_.isotopChains.begin(); it_z !=  result_.isotopChains.end(); ++it_z){
                ...
                for (std::vector< std::vector< int > >::iterator it_c = (*it_z).begin(); it_c !=  (*it_z).end(); ++it_c){
                    ...
                    // the winner is tbd
                    dIntensityInnerProduct = 0.0;
                    dIntensityInnerProduct = inner_product(beginIntensity, (*it_c).begin(), (*it_c).end(), LIsotopeEnvelope.begin(), LIsotopeEnvelope.end(), dIntensityInnerProduct, dIntensityL2);
                    Lscore.push_back(dIntensityInnerProduct);

                    dIntensityInnerProduct = 0.0;
                    std::vector< int > ::iterator it_c_begin_succ = (*it_c).begin();
                    ++it_c_begin_succ;
                    dIntensityInnerProduct = inner_product(beginIntensity, it_c_begin_succ, (*it_c).end(), LIsotopeEnvelope.begin(), LIsotopeEnvelope.end(), dIntensityInnerProduct, dIntensityL2);
                    Lscore1.push_back(dIntensityInnerProduct);
                } //  END for all chains
